<template>
  <!-- Version update notification component with default theme styling -->
    ...
    <div class="version-notification-dialog">
      ...
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center space-x-3">
          ...
          <h3 class="text-xl font-semibold text-gray-900">{{ $t('version.update_available') }}</h3>
        </div>
        <button 
      ...
      <div class="version-info mb-6">
        <div class="flex justify-between items-center mb-2">
          <span class="text-gray-600">{{ $t('version.current_version') }}:</span>
          <span class="text-gray-900 font-mono">{{ versionInfo.currentVersion }}</span>
        </div>
        <div class="flex justify-between items-center mb-4">
          <span class="text-gray-600">{{ $t('version.latest_version') }}:</span>
          <span class="text-green-600 font-mono font-semibold">{{ versionInfo.latestVersion }}</span>
        </div>
