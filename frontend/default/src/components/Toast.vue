<template>
  <div class="fixed z-[9999] left-1/2 top-4 transform -translate-x-1/2 flex flex-col gap-2 items-center w-full max-w-xs pointer-events-none">
    <transition-group name="toast-fade" tag="div">
      <div v-for="(toast, i) in toasts" :key="toast.id" :class="toastClass(toast.type)" class="w-full px-4 py-2 rounded shadow flex items-center gap-2 animate-fade-in-out pointer-events-auto">
